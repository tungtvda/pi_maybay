...
function view_datdichvu($data)
{
    ...
    $ft->assign('TABLE-NAME','datdichvu');
...
{
    return '<th>Id</th><th>LoaiDichVu</th><th>TrangThai</th><th>Tên</th><th>Email</th><th>Điện Thoại</th><th>Created</th>';
}
//
function showTableBody($data)
{
    ...
    if(count($data)>0) foreach($data as $obj)
    {
        ...
        $TableBody.="<td>".$obj->LoaiDichVu."</td>";
...
{
    $str_from='';
    $str_from.='<p><label>LoaiDichVu</label><input class="text-input small-input" type="text"  name="LoaiDichVu" value="'.(($form!=false)?$form->LoaiDichVu:'').'" /></p>';
