...
{
    return '<th>Id</th><th>Tên</th><th>QuyDanh</th><th>Điện Thoại</th><th>Email</th><th>TrangThai</th><th>Created</th>';
}
//
...
function showFrom($form,$ListKey=array())
{
    ...
    $str_from.='<p><label>QuyDanh</label><input class="text-input small-input" type="text"  name="QuyDanh" value="'.(($form!=false)?$form->QuyDanh:'').'" /></p>';
