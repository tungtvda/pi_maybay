...
$data['pagesize']=20;
$data['count']=venoidia_count('DanhMucId=2');
$data['danhsach']=venoidia_getByPaging($data['current'],$data['pagesize'],'Id DESC','DanhMucId=2');
$data['PAGING'] = showPagingAtLink($data['count'], $data['pagesize'], $data['current'], '' . SITE_NAME . '/ve-quoc-te/');
