                            ...
                            <table width="100%" class="price-break">
                                ...
                                <?php if($val->AirlineCode == "VietJetAir" || $val->AirlineCode == "JetStar") {
                                    foreach($val->PriceSummaries as $PriSumm) {
                                        ...
                                        $price_total2 = 0;
                                        $price_total = 0;
                                        if($PriSumm->PassengerType && $PriSumm->PassengerType == 'ADT') { ?>
                                            <?php if($PriSumm->Code == "NET") {
                                                $price_total1 += $PriSumm->Price*$PriSumm->Quantity; ?>
                                                <td align="center" class="pax">Người lớn</td>
                                                <td align="center" class="pax"><?php echo $PriSumm->Quantity ?></td>
                                                <td align="center" class="pax pb-price"><?=number_format($PriSumm->Price, 0, ',','.')?> vnđ</td>
                                            <?php }
                                            if($PriSumm->Code == "TAX") {
                                                $price_total1 += $PriSumm->Price*$PriSumm->Quantity; ?>
                                                <td align="center" class="pax pb-price"><?php echo number_format($PriSumm->Price, 0, ',','.'); ?> vnđ</td>
                                            <?php }
                                            $price_total += $price_total1;
                                            ?>
                                            <td align="center" class="pax pb-price"><?php echo number_format($price_total, 0, ',','.'); ?> vnđ</td>
                                        <?php }
                                        if($PriSumm->PassengerType && $PriSumm->PassengerType == 'CHD') { ?>
                                            <tr>
                                                <?php if($PriSumm->Code == "NET") {
                                                    $price_total2 += $PriSumm->Price*$PriSumm->Quantity; ?>
                                                ...
                                                if($PriSumm->Code == "TAX") {
                                                    ...
                                                    <td align="center" class="pax pb-price"><?php echo number_format($PriSumm->Price, 0, ',','.'); ?> vnđ</td>
                                                <?php }
                                                $price_total += $price_total2;
                                                ?>
                                                <td align="center" class="pax pb-price"><?php echo number_format($price_total2, 0, ',','.'); ?> vnđ</td>
                                            </tr>
                                        <?php }
                                    } ?>
                                    <tr class="total-b">
                                    ...
                                    foreach($val->PriceSummaries as $PriSumm) {
                                        ...
                                        if($PriSumm->PassengerType && $PriSumm->PassengerType == 'ADT') { ?>
                                            <tr>
                                                ...
                                                $price_total += $price_total1;
                                                ?>
                                                <td align="center" class="pax pb-price"><?php echo number_format($price_total1, 0, ',','.'); ?> vnđ</td>
                                            </tr>
                                        <?php }
                                        if($PriSumm->PassengerType && $PriSumm->PassengerType == 'CHD') { ?>
                                            <tr>
                                        ...
                                        <?php }
                                        if($PriSumm->PassengerType && $PriSumm->PassengerType == 'INF') { ?>
                                            <tr>
                                                <?php if($PriSumm->Code == "NET") {
                                                    $price_total3 += $PriSumm->Price*$PriSumm->Quantity; ?>
                                                ...
                                                if($PriSumm->Code == "TAX") {
                                                    ...
                                                    <td align="center" class="pax pb-price"><?php echo number_format($PriSumm->Price, 0, ',','.'); ?> vnđ</td>
                                                <?php }
                                                $price_total += $price_total3;
                                                ?>
                                                <td align="center" class="pax pb-price"><?php echo number_format($price_total3, 0, ',','.'); ?> vnđ</td>
                                            </tr>
                                        <?php }
                                    } ?>
                                    <tr class="total-b">
