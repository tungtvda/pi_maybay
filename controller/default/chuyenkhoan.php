...
$data['danhmuc']=menu_getById(11);

        $data['chitiet']=thanhtoan_chuyenkhoan_getById(1);
...
if($_SESSION['kiemtra']==1)
{
    ...
    $data['NoiDung']=$data['chitiet'][0]->ThongTinChuyenKhoan;
    $data['Name']="";
...
else
{
    ...
    $data['NoiDung']=$data['chitiet'][0]->ThongTinChuyenKhoan_en;
    $data['Name']="";
